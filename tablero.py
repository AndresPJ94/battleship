...
class Tablero:
    ...
    def colocar_barcos_random(self):   #Esta función nos genera el tablero random nuestro (jugamos contra la máquina)
        ...
        for barco in barcos:
            while True:
                ...
                # 4 posibles posiciones, las comprobamos.
    ...
    def colocar_barcos_manual(self):  #Esta función nos coloca manualmente los barcos para la máquina.
        barcos = (4, 3, 3, 2, 2, 2, 1, 1, 1, 1)
        ...
        for barco in barcos:
                ...
                while i and j not in coordenadas:  #Comprobamos que las i y j estén dentro del rango válido de coordenadas.
